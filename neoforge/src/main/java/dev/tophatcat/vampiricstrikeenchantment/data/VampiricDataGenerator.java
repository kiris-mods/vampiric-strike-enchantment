...
public class VampiricDataGenerator extends DatapackBuiltinEntriesProvider {
    ...
    public static final ResourceKey<Enchantment> VAMPIRIC_STRIKE = ResourceKey.create(Registries.ENCHANTMENT,
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context) {
        ...
        register(context, VAMPIRIC_STRIKE, Enchantment.enchantment(Enchantment.definition(
            ...
            .withEffect(EnchantmentEffectComponents.POST_ATTACK, EnchantmentTarget.ATTACKER,
                EnchantmentTarget.VICTIM, new VampiricStrikeEffect(LevelBasedValue.perLevel(1))));
    }
